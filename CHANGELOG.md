...
- Water in Wells - Mesh-only Animated Wells v0.3: A mesh-only solution for animated water in wells and sewers. No ESP. 
...
- High Poly Project v5.2: An on going process to improve the models of the game with more polygons, UV edits or just replace them all together. SMIM was the inspiration and the lack of similar mods led me to make this.
