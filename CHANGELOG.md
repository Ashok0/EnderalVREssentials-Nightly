...
- DynDOLOD Standalone 3.0 Alpha-106: DynDOLOD is a set of simple tools based on xEdit/xLODGen to automatically create a Skyrim mod based on the load order which adds distant LOD for objects and trees to Skyrim. By combining DynDOLOD with xLODGen users can create drastically enhanced static object LOD + tree LOD and the new, optional dynamic distant object LOD in a few simple steps.
...
New Mods:
- PLANCK - Physical Animation and Character Kinetics v0.4.6: Physically-driven animation in Skyrim. Characters interact with physics and can be grabbed, melee hit detection is physically accurate, and much more.
...
- Simplicity of Snow v0.9: A light-weight snow mod designed to minimize conflicts. Uses your own snow texture and removes snow from under roofs.
...
- Crash Logger v1.3.1: Provide more info on TESForm and NiAVObject (names/editor IDs).
...
- VR Address Library for SKSEVR v0.63: Add latest commonlib, po3 addresses (02026b1)
