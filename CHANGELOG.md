...
- Spell Perk Item Distributor VR v5.0.2: An SKSE plugin that can be used to add spells/leveled spells/perks/items/leveled items/shouts/packages/outfits to every NPC in the game, using config files.
- Terrain LOD for Septentrional Landscapes v1.1: Only needed for noise texture.  All files removed except for the \textures\ folder.
