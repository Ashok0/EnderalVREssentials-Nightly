...
- DynDOLOD Standalone 3.0 Alpha-93: DynDOLOD is a set of simple tools based on xEdit/xLODGen to automatically create a Skyrim mod based on the load order which adds distant LOD for objects and trees to Skyrim. By combining DynDOLOD with xLODGen users can create drastically enhanced static object LOD + tree LOD and the new, optional dynamic distant object LOD in a few simple steps.
...
- Simplicity of Snow v0.6.4.1: A light-weight snow mod designed to minimize conflicts. Uses your own snow texture and removes snow from under roofs.
...
- HIGGS - Enhanced VR Interaction v1.5.5: Hand/weapon collision, weapon two-handing, realistic object grabbing, and gravity gloves-style mechanics for Skyrim VR.
...
- VR Address Library for SKSEVR v0.34.1: Add latest commonlib, po3 addresses (02026b1)
