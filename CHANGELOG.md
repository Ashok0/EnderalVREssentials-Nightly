...
New Mods:
- PLANCK - Physical Animation and Character Kinetics v0.3.0: Physically-driven animation in Skyrim. Characters interact with physics and can be grabbed, melee hit detection is physically accurate, and much more.
