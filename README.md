...
Latest update: December 19th, 2021 (v1.106)
...
[**Path of the Prophet (No Floating Quest Marker) v1.01**](https://www.nexusmods.com/enderalspecialedition/mods/332?tab=files): Removes floating quest markers from the game.  Quest markers are still viewable on the compass.
